/**
 * Genererar migrationen för KQ2 (SMC snabbkopplingar, metrisk slang) ur den
 * kanoniska modellen — en ny familj; de nio produktraderna får SMC-prefix,
 * den nya nyckelns materialbokstav och rätt gängbeteckning.
 *
 ...
 * 102), G-, plantätnings- och Uni-nycklarna (sida 58, 66, 88), 1 540
 * modellnummer ur måttabellerna, M3 bara i rostfritt, honkopplingarna utan S,
 * och 60 000+ kombinationer regler↔modell.
 */
import { KQ2_BUTTON, KQ2_MATERIALS, KQ2_ORDER_CODE_TEMPLATE, KQ2_PORTS, KQ2_SEALS, KQ2_SOURCE, KQ2_TUBES, KQ2_TYPES, kq2BuildCode, kq2ParseCode } from "../src/lib/catalog/kq2.ts";
