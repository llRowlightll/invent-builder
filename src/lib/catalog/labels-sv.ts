...
const VALUE_SV: Record<string, string> = {
  ...
  // "Justerbar dämpning + magnetkolv" är 31 tecken och kapas till
  // "Justerbar dämpning + magnetk" i knappen. Förkortningen är vedertagen i
  // svenska tekniska listor och ryms.
  "Adjustable cushioning + magnetic piston": "Just. dämpning + magnetkolv",
  "Angular": "Vinkelgrepp",
  "Anodised aluminium piston rod": "Anodiserad aluminiumstång",
  "ATEX certified": "ATEX-certifierad",
  "Ball screw (precise)": "Kulskruv (precis)",
  "Basic variant": "Grundutförande",
  "Battery production (low Cu/Zn/Ni)": "Batteri, låg Cu/Zn/Ni",
  "Centric": "Centrerande",
  ...
  "Heat-resistant seals (to 120°C)": "Värmetåliga tätningar 120 °C",
  ...
  "High-flow Filter-Regulator": "Filter-regulator, högt flöde",
  ...
  "Multi-pin (no bus)": "Multipol (utan buss)",
  ...
  "Pneumatic adjustable (self-adj.)": "Pneumatisk, självjusterande",
  ...
  "Single acting spring return": "Enkelverkande, fjäderretur",
  "SLIDELINE — roller": "SLIDELINE — Rulle",
  "Square piston rod (anti-rotation)": "Fyrkantig, vridsäker stång",
  "Square stainless rod": "Fyrkantig rostfri kolvstång",
  "SR — Single acting spring return": "SR — Enkelverkande, fjäderretur",
  "SRD — Double acting": "SRD — Dubbelverkande",
  "SRDM — Double acting magnetic": "SRDM — Dubbelverkande, magnetkolv",
  "SRM — Single acting magnetic": "SRM — Enkelverkande, magnetkolv",
