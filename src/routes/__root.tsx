...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Hitta rätt pneumatisk cylinder, elektrisk aktuator, ventil eller gripper — Festo, SMC, Parker, Bosch Rexroth, Norgren, Metal Work, Camozzi. AI-sökning, jämförelse och komplett stycklista på sekunder." },
      { property: "og:site_name", content: "Maskinval" },
      { property: "og:title", content: "Maskinval — Industriell automation" },
      { property: "og:description", content: "Sök tvärs Festo, SMC, Parker, Bosch Rexroth, Norgren, Metal Work och Camozzi. AI-driven komponentväljare med stycklista och offertförfrågan." },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "sv_SE" },
      { property: "og:locale:alternate", content: "en_US" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Maskinval — Industriell automation" },
      { name: "twitter:description", content: "AI-sökning för pneumatik och automation. Festo, SMC, Parker, Bosch Rexroth, Norgren, Metal Work, Camozzi." },
