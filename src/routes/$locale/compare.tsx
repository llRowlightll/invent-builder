  ...
  return [
    ...
    },
    {
      ...
      rows: [
        ...
        { kind: "spec", label: t("comparePage.label_max_stroke"),  key: "stroke_mm" },
        { kind: "spec", label: t("comparePage.label_stroke_range"),key: "stroke_range" },
        { kind: "spec", label: t("comparePage.label_bore_range"),  key: "bore_range" },
    ...
    },
    {
      ...
      rows: [
        ...
        { kind: "spec", label: t("comparePage.label_special"),     key: "special_features" },
