...
from configurator_families f,
     jsonb_to_recordset('[{"param_key":"rotation_lock","label":"Vridskydd","param_type":"select","sort_order":1,"required":false},{"param_key":"running","label":"Gångegenskaper","param_type":"select","sort_order":2,"required":false},{"param_key":"bore_mm","label":"Kolvdiameter","param_type":"select","sort_order":3,"required":true},{"param_key":"stroke_mm","label":"Slaglängd","param_type":"number","sort_order":4,"required":true},{"param_key":"clamping","label":"Klämenhet","param_type":"select","sort_order":5,"required":false},{"param_key":"end_lock","label":"Ändlägeslåsning","param_type":"select","sort_order":6,"required":false},{"param_key":"rod_type","label":"Kolvstångstyp","param_type":"select","sort_order":7,"required":false},{"param_key":"rod_thread","label":"Kolvstångsgänga","param_type":"select","sort_order":8,"required":false},{"param_key":"profile","label":"Profiltyp","param_type":"select","sort_order":9,"required":false},{"param_key":"cushioning","label":"Dämpning","param_type":"select","sort_order":10,"required":true},{"param_key":"sensing","label":"Lägesavkänning","param_type":"select","sort_order":11,"required":false},{"param_key":"standard_conformity","label":"Standard","param_type":"select","sort_order":12,"required":false},{"param_key":"corrosion","label":"Korrosionsskydd","param_type":"select","sort_order":13,"required":false},{"param_key":"temperature","label":"Temperaturområde","param_type":"select","sort_order":14,"required":false},{"param_key":"particles","label":"Partikelskydd","param_type":"select","sort_order":15,"required":false},{"param_key":"scraper","label":"Avstrykarvariant","param_type":"select","sort_order":16,"required":false},{"param_key":"material","label":"Särskilda materialegenskaper","param_type":"select","sort_order":17,"required":false},{"param_key":"eu_cert","label":"EU-certifiering","param_type":"select","sort_order":18,"required":false},{"param_key":"stroke_adjust_mm","label":"Slagjustering, utgående","param_type":"number","sort_order":19,"required":false},{"param_key":"rod_extension_mm","label":"Kolvstångsförlängning","param_type":"number","sort_order":20,"required":false},{"param_key":"rod_thread_extension_mm","label":"Gängförlängning på kolvstång","param_type":"number","sort_order":21,"required":false}]'::jsonb)
